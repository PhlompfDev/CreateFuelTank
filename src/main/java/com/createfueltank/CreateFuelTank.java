...
@Mod(CreateFuelTank.ID)
public class CreateFuelTank {
    public static final String ID = "createfueltank";
    ...
    public CreateFuelTank(IEventBus modBus, ModContainer container) {
        ...
        FuelTankBlocks.register();
        FuelTankBlockEntities.register();
